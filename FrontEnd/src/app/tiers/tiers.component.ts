...
export class TiersComponent {
    ...
    constructor(private httpRequests: HttpRequestsService, private route: ActivatedRoute, @Inject('BASE_URL') baseUrl: string, private router: Router) {
                ...
                this.route.params.subscribe(params => {
                    ...
                    if (this.showAll) {
                        this.httpRequests.getTierClass().subscribe(data => {
                            console.log("All tiers", data);
                            if (data['status'] == '1') {

                                this.TierClasses = data['tierClasses'].slice();
